...
'''
    脚本功能： 根据excel模板文档，自动生成hive建表ODS_S层的sql文件
'''
...
if __name__ == '__main__':
    dir_path = r"D:\gitDoc\ts-fdw-doc\数仓设计和开发\1.SRC&ODS层\银行卡POS收单系统-PSCPOS/"
    file_name = "POSTMISJNL-MISPOS交易流水表.xlsx"
